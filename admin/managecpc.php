     ...
     <div class="container-fluid">
      ...
      <div class="row">
       ...
       <div class="card-header">
         <h3 class="card-title">Manage CPC Post</h3>
       ...
       <div class="card-body p-0">
               ...
               <?php
                   ...
                   $sql = "SELECT * FROM club_cpc";
                     ...
                     <td class="project-actions text-right">
                         ...
                         <a class="btn btn-info btn-sm" href="editcpc.php?update=<?php echo $id; ?>">
         ...
         $deleteImageSQL = "SELECT * FROM club_cpc WHERE id ='$deletecpcpoct'";
                 ...
                 $sql = "DELETE FROM club_cpc WHERE id ='$deletecpcpoct'";
