       ...
       <div class="row mb-2">
         ...
         <div class="col-sm-6">
           <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item active">Add GCPC Post</li>
           </ol>
         </div><!-- /.col -->
       </div><!-- /.row -->
     </div><!-- /.container-fluid -->
      ...
      <div class="row">
       <div class="col-lg-6">
           ...
           <div class="form-group">
             ...
             <input type="submit" name="addGCpc" class="btn btn-block btn-primary btn-flat" value="Add CPC Post">       
           </div>
             </form>
       ...
       <?php
         ...
         if (isset($_POST['addGCpc'])) {
                ...
                $imagetmp    = $_FILES['image']['tmp_name'];
                 ...
                 $sql = "INSERT INTO club_gcpc(title,description,registration_link,image,status) VALUES('$title','$description','$registration_link','$image','$status')";
                ...
                $mail->Host       = 'smtp.gmail.com';                     //Set the SMTP server to send through
                    ...
                    $mail->Body    ='<b>Welcome to GCPC</b> <br>'.$title.'<br>'.$description.'<br>
                    Thank You........';
