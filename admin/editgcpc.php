         ...
         <?php
          ...
          if (isset($_GET['update'])) {
            $theUpdate = $_GET['update'];
              $sql = "SELECT * FROM club_gcpc WHERE id = '$theUpdate'  ";
       ...
       if (isset($_POST['updatecpc'])) {
          $updateCPCMaterial=$_POST['updateCPCMaterial'];
                 ...
                 $imagetmp    = $_FILES['image']['tmp_name'];
                  ...
                  $deleteImageSQL = "SELECT * FROM club_gcpc WHERE id ='$updateCPCMaterial'";
                  ...
                  move_uploaded_file( $imagetmp, "img/course/" .$image);
                    ...
                    $sql = "UPDATE club_gcpc SET title='$title',description='$description',registration_link='$registration_link',image='$image',status='$status' WHERE id ='$updateCPCMaterial' ";
