      ...
      <div class="container">
       ...
       <div class="row">
        ...
        <div class="card-header">
          <h3 class="card-title">Manage All Research</h3>
          ...
          <table id="choton" class="table table-striped projects ">
              ...
              <tbody>
                ...
                <?php
                  ...
                  $sql = "SELECT * FROM course_level_area";
                      ...
                      <td class="project-actions text-right">
                         ...
                         <!--  <a class="btn btn-info btn-sm" href="editresearch.php?update=<?php echo $id; ?>">
                          ...
                          <a class="btn btn-danger btn-sm" href="?delete=<?php echo $level_id; ?>">
            ...
            <?php    }
                ...
                <?php
                 ...
                 $deleteId = $_GET['delete'];
                  ...
                  $sql = "DELETE FROM course_level WHERE level_id ='$deleteId'";
